...
listItems = []
itemInfos = [
  { title: '카카오톡', info: '32회 실행 / 14:00 사용 / 42.4MB', icon: './images/app0.png' }
  { title: '쿠팡 - 소셜 커머스', info: '32회 실행 / 14:00 사용 / 256.1MB 사용', icon: './images/app1.png' }
  { title: '알송 모바일 - mp3 뮤직 플레이어', info: '32회 실행 / 14:00 사용 / 256.1MB 사용', icon: './images/app2.png' }
  { title: 'Tranvalloon 트래벌룬', info: '32회 실행 / 14:00 사용 / 235MB 사용', icon: './images/app3.png' }
  { title: '엔젤스톤 with NAVER', info: '32회 실행 / 14:00 사용 / 777MB 사용', icon: './images/app4.png' }
  { title: '카카오택시 kakaoTaxi', info: '32회 실행 / 14:00 사용 / 256.1MB 사용', icon: './images/app5.png' }
  { title: '옥션 kakaoTaxi', info: '32회 실행 / 14:00 사용 / 256.1MB 사용', icon: './images/app6.png' }
  { title: 'V - 스타 레알 라이브 방송 앱', info: '32회 실행 / 14:00 사용 / 256.1MB 사용', icon: './images/app7.png' }
  { title: '카카오톡', info: '32회 실행 / 14:00 사용 / 42.2MB 사용', icon: './images/app0.png' }
  { title: '쿠팡 - 소셜 커머스', info: '32회 실행 / 14:00 사용 / 256.1MB 사용', icon: './images/app1.png' }
  { title: '알송 모바일 - mp3 뮤직 플레이어', info: '32회 실행 / 14:00 사용 / 256.1MB 사용', icon: './images/app2.png' }
  { title: 'Tranvalloon 트래벌룬', info: '32회 실행 / 14:00 사용 / 235MB 사용', icon: './images/app3.png' }
  { title: '엔젤스톤 with NAVER', info: '32회 실행 / 14:00 사용 / 777MB 사용', icon: './images/app4.png' }
...
class ListItem extends L
  constructor: (seq, item)->
    ...
    @downloadButton = new Button
      ...
      height: dp 32
      borderRadius: dp 4
      backgroundColor: color.downloadButton
      superLayer: @
    @downloadButtonIcon = new L
      width: dp 14
      height: dp 14
      image: './images/download-icon.png'
      superLayer: @downloadButton
    @downloadButtonIcon.center()
    title = new L
      x: dp 70
      y: dp 14
      height: dp 13
